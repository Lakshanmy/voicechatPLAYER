...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("CyberPlayer ⏸ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("CyberPlayer▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("CyberPlayer⏹ Stopped streaming.")
...
async def skip(client: Client, message: Message):
    ...
    if sira.is_empty(chat_id):
        ...
        await message.reply_text("CyberPlayer⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("CyberPlayer❇️ Admin cache refreshed!")
